...
#submenu-div a.fix-submenu{ 
  clear:both; margin-left:5px; padding:1px 5px; *padding:3px 5px 5px; 
background: #fcbc3c;
  background-image: -webkit-linear-gradient(top, #fcbc3c, #d98934);
  background-image: -moz-linear-gradient(top, #fcbc3c, #d98934);
  background-image: -ms-linear-gradient(top, #fcbc3c, #d98934);
  background-image: -o-linear-gradient(top, #fcbc3c, #d98934);
  background-image: linear-gradient(to bottom, #fcbc3c, #d98934);
...
#submenu-div a.fix-submenu:hover{
 ...
 background: #e6ab35;
  background-image: -webkit-linear-gradient(top, #e6ab35, #cf7f30);
  background-image: -moz-linear-gradient(top, #e6ab35, #cf7f30);
  background-image: -ms-linear-gradient(top, #e6ab35, #cf7f30);
  background-image: -o-linear-gradient(top, #e6ab35, #cf7f30);
  background-image: linear-gradient(to bottom, #e6ab35, #cf7f30);
  text-decoration: none;
}
...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/ecshop_logo.png" alt="Warket" /></div>
