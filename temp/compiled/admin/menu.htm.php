...
#main-div {
  border:1px solid #488a54;
-webkit-box-shadow: inset 0px 0px 24px -4px rgba(0,0,0,0.52);
-moz-box-shadow: inset 0px 0px 24px -4px rgba(0,0,0,0.52);
box-shadow: inset 0px 0px 24px -4px rgba(0,0,0,0.52);
  padding: 5px;
  margin: 5px;
  background: #FFF;
}
