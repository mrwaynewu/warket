...
<?php echo $this->smarty_insert_scripts(array('files'=>'gototop.js')); ?>
</head>
<body>
    ...
    <div class="box_shadow">
     <div>
      <div style="padding:20px 15px;">
         <div class="tc" style="padding:0px;">
		 
		<table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
		<tr>
		<td>
         <font style="color:#4fb75e;font-size: 1.3em;font-weight: bold;"><?php echo htmlspecialchars($this->_var['article']['title']); ?></font><br />
		</td>
		</tr>
