...
<title>手机配件_ECSHOP演示站 - Powered by PBCC</title>
 ...
 <div class="box_shadow"  id="left_nav">
  ...
  <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
	...
	<td style="width:10px;">
		...
		<tr>
		<td style="width:100%;">
	    <a href="category.php?id=1" style="font-weight:700;color: #4fb75e;padding:1px 2px;">手机类型</a><br />
		</td>
	</tr>
	<tr height="1"><td><table border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #e0e0e0;height:1px;width: 100%;"><tr><td></td></tr></table></td></tr>
	...
	<td style="width:10px;">
		...
		<tr>
		<td style="width:100%;">
		<a href="category.php?id=6" style="font-weight:700;background-color:#4fb75e;color:#fff;padding:1px 2px;">手机配件</a><br />
		</td>
	</tr>
	<tr height="1"><td><table border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #e0e0e0;height:1px;width: 100%;"><tr><td></td></tr></table></td></tr>
...
<td style="">		
				<div style="display: block;">
								...
								<div class="filter_div" style="">
										<a href="category.php?id=6&amp;brand=1&amp;price_min=0&amp;price_max=0" class="filter_a">诺基亚</a>&nbsp;
									</div>
								<div class="filter_div" style="">
										<a href="category.php?id=6&amp;brand=7&amp;price_min=0&amp;price_max=0" class="filter_a">索爱</a>&nbsp;
									</div>
								</div>
</td>
</tr>
...
<td style="text-align:right; padding:0px 10px;">
  ...
  <a href="category.php?category=6&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img width="60" src="themes/test1/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=6&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img height="20" src="themes/test1/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=6&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img width="60" src="themes/test1/images/last_update_default.gif" alt="按更新时间排序"></a>
...
<td>
    ...
    <div class="clearfix goodsBox" style="border:none;">
		...
		<div style="padding:2px;">
           <a href="goods.php?id=7"><img src="images/200905/thumb_img/7_thumb_G_1241422785492.jpg" alt="诺基亚N85原..." class="goodsimg" /></a>
		</div>
		   ...
		   <li>
           <a href="javascript:collect(7);" class="f6">
		   ...
		   <li>
           <a href="javascript:addToCart(7)" class="f6" style="width:70px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">立即购买</div>
		   ...
		   <li>
		   <a href="javascript:addToCart(7)" class="f6" style="border-right:none;width:73px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">加入购物车</div>
...
border: 0px solid #000000;color:#fff;background-color:#fd671d;">加入购物车</div>
		...
		<div style="padding:2px;">
           <a href="goods.php?id=5"><img src="images/200905/thumb_img/5_thumb_G_1241422518886.jpg" alt="索爱原装M2卡..." class="goodsimg" /></a>
		</div>
		   ...
		   <ul class="goods_action">
		   <li>
           <a href="javascript:collect(5);" class="f6">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">收藏</div>
		   <div style="border-radius: 0px 0px 0px 3px;
		   ...
		   <li>
           <a href="javascript:addToCart(5)" class="f6" style="width:70px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">立即购买</div>
		   <div style="color:#fff;background-color:#fd671d;">立即购买</div>
		   ...
		   <li>
		   <a href="javascript:addToCart(5)" class="f6" style="border-right:none;width:73px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">加入购物车</div>
		   <div style="border-radius: 0px 0px 3px 0px;
...
border: 0px solid #000000;color:#fff;background-color:#fd671d;">加入购物车</div>
		...
		<div style="padding:2px;">
           <a href="goods.php?id=3"><img src="images/200905/thumb_img/3_thumb_G_1241422082679.jpg" alt="诺基亚原装58..." class="goodsimg" /></a>
		</div>
		   ...
		   <ul class="goods_action">
		   <li>
           <a href="javascript:collect(3);" class="f6">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">收藏</div>
		   <div style="border-radius: 0px 0px 0px 3px;
		   ...
		   <li>
           <a href="javascript:addToCart(3)" class="f6" style="width:70px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">立即购买</div>
		   <div style="color:#fff;background-color:#fd671d;">立即购买</div>
		   ...
		   <li>
		   <a href="javascript:addToCart(3)" class="f6" style="border-right:none;width:73px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">加入购物车</div>
		   <div style="border-radius: 0px 0px 3px 0px;
