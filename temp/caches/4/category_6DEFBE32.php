...
<title>菜园_ECSHOP演示站 - Powered by PBCC</title>
...
<div id="mainNav" class="clearfix">
  <a href="index.php">&emsp;首页&emsp;</a>
    <a href="category.php?id=16"   class="cur">
    菜园 
          </a>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">菜园</a> </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
...
<div class="">
 <div class="box_shadow"  id="left_nav">
  ...
  <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
		...
		<tr>
		<td style="width:100%;">
		<a href="category.php?id=16" style="font-weight:700;background-color:#4fb75e;color:#fff;padding:1px 2px;">菜园</a><br />
		</td>
	</tr>
...
<td style="text-align:right; padding:0px 10px;">
  ...
  <a href="category.php?category=16&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img width="60" src="themes/test1/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=16&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img height="20" src="themes/test1/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=16&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img width="60" src="themes/test1/images/last_update_default.gif" alt="按更新时间排序"></a>
...
<td>
    ...
    <div class="clearfix goodsBox" style="border:none;">
		...
		<div style="padding:2px;">
           <a href="goods.php?id=34"><img src="images/201503/thumb_img/34_thumb_G_1425539534682.jpg" alt="花菜" class="goodsimg" /></a>
		</div>
           ...
           <p><a href="goods.php?id=34" title="花菜">花菜</a></p>
                       市场价<font class="market_s">￥968元</font><br />
		   ...
		   <li>
           <a href="javascript:collect(34);" class="f6">
		   ...
		   <li>
           <a href="javascript:addToCart(34)" class="f6" style="width:70px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">立即购买</div>
		   ...
		   <li>
		   <a href="javascript:addToCart(34)" class="f6" style="border-right:none;width:73px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">加入购物车</div>
...
border: 0px solid #000000;color:#fff;background-color:#fd671d;">加入购物车</div>
		...
		<div style="padding:2px;">
           <a href="goods.php?id=33"><img src="images/201503/thumb_img/33_thumb_G_1425468634488.jpg" alt="西兰花" class="goodsimg" /></a>
		</div>
		   ...
		   <div style="padding:4px;">
           <p><a href="goods.php?id=33" title="西兰花">西兰花</a></p>
		   ...
		   <ul class="goods_action">
		   <li>
           <a href="javascript:collect(33);" class="f6">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">收藏</div>
		   <div style="border-radius: 0px 0px 0px 3px;
		   ...
		   <li>
           <a href="javascript:addToCart(33)" class="f6" style="width:70px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">立即购买</div>
		   <div style="color:#fff;background-color:#fd671d;">立即购买</div>
		   ...
		   <li>
		   <a href="javascript:addToCart(33)" class="f6" style="border-right:none;width:73px;">
		   <div class="goods_action_div_wrapper">
		   <div class="goods_action_div_wrapper_container">
		   <div style="">加入购物车</div>
		   <div style="border-radius: 0px 0px 3px 0px;
