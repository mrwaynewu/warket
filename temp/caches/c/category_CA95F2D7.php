...
<td>
    ...
    <div class="clearfix goodsBox" style="border:none;">
		...
		<div style="padding:2px;">
		   ...
		   <li>
           <a href="javascript:addToCart(7)" class="f6" style="width:71px;">立即购买</a>
           </li>
		   <li>
		   <a href="javascript:addToCart(7)" class="f6" style="width:72px;">加入购物车</a>
		   </li>
		   </ul>
		   </div>
		...
		<div style="padding:2px;">
		   ...
		   <li>
           <a href="javascript:addToCart(5)" class="f6" style="width:71px;">立即购买</a>
           </li>
		   <li>
		   <a href="javascript:addToCart(5)" class="f6" style="width:72px;">加入购物车</a>
		   </li>
		   </ul>
		   </div>
		...
		<div style="padding:2px;">
		   ...
		   <li>
           <a href="javascript:addToCart(3)" class="f6" style="width:71px;">立即购买</a>
           </li>
		   <li>
		   <a href="javascript:addToCart(3)" class="f6" style="width:72px;">加入购物车</a>
		   </li>
		   </ul>
		   </div>
