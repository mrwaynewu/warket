...
<title>CDMA手机_ECSHOP演示站 - Powered by PBCC</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">CDMA手机</a> </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
 ...
 <div class="box_shadow"  id="left_nav">
  ...
  <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
	...
	<table border="0" cellspacing="0" cellpadding="0" style="padding:4px;">
		...
		<td>
      	  	  <a href="category.php?id=2" style=" color: #4fb75e;font-weight:500;border:1px solid #4fb75e;">CDMA手机</a><br />
...
<td style="">		
				<div style="display: block;">
								...
								<div class="filter_div" style="">
										<a href="category.php?id=2&amp;brand=4&amp;price_min=0&amp;price_max=0" class="filter_a">飞利浦</a>&nbsp;
									</div>
								</div>
</td>
</tr>
...
<td style="">			
			...
			<div style="display: block;">
						...
						<div class="filter_div" style="">
								<a href="category.php?id=2&amp;price_min=390&amp;price_max=400" class="filter_a">390&nbsp;-&nbsp;400</a>&nbsp;
							</div>
						</div>
...
<td style="text-align:right; padding:0px 10px;">
  ...
  <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img width="60" src="themes/test1/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img height="20" src="themes/test1/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img width="60" src="themes/test1/images/last_update_default.gif" alt="按更新时间排序"></a>
