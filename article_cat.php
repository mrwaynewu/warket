...
if (!$smarty->is_cached('article_cat.dwt', $cache_id))
{
	...
	$cat_arry = get_left_article_nav($_REQUEST['id'],1);//type: 0 means its based on article_id, 1 means its based on cat_id
    $smarty->assign('article_categories', $cat_arry); //文章分类树
